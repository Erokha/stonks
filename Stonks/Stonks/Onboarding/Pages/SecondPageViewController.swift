...
extension SecondPageViewController {
    private struct Constants {
        ...
        struct ImageContainerView {
            ...
            static let topPercent: Percent = 15%
        ...
        struct ImageView {
            static var imageName: String {
                if UITraitCollection.current.userInterfaceStyle == .dark {
                    return "darkUnlimited"
                } else {
                    return "lightUnlimited"
                }
            }
        ...
        struct MainTitleLabel {
            static let text: String = "Unlimited free account"
        ...
        struct SubtitleLabel {
            ...
            static let text: String = "Top up your balance free when you need to."
