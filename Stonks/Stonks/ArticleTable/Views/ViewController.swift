...
//        tableView.register(NewArticleTableViewCell.self, forCellReuseIdentifier: NewArticleTableViewCell.reuseIdentifier)
...
//
//        guard let cell = tableView.dequeueReusableCell(withIdentifier: NewArticleTableViewCell.reuseIdentifier, for: indexPath) as? NewArticleTableViewCell else {
